...
extension Color {
    static let background = LinearGradient(gradient: Gradient(colors: [Color("Background 1"), Color("Background 2")]), startPoint: .top, endPoint: .bottom)
...
extension View {
    func backgroundBlur(radius: CGFloat = 3, opaque: Bool = true) -> some View {
        self
            .background(
